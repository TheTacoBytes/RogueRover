...
bool rr_msgs__msg__position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rr_msgs.msg._position.Position", full_classname_dest, 30) == 0);
  }
  rr_msgs__msg__Position * ros_message = _ros_message;
  {  // angle_x
...
PyObject * rr_msgs__msg__position__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rr_msgs.msg._position");
