...
bool rr_msgs__msg__image_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rr_msgs.msg._image_msg.ImageMsg", full_classname_dest, 31) == 0);
  }
  rr_msgs__msg__ImageMsg * ros_message = _ros_message;
  {  // height
...
PyObject * rr_msgs__msg__image_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rr_msgs.msg._image_msg");
