...
class Metaclass_Kinematics(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rr_msgs.srv import _kinematics
...
class Kinematics(metaclass=Metaclass_Kinematics):
    from rr_msgs.srv._kinematics import Kinematics_Request as Request
    from rr_msgs.srv._kinematics import Kinematics_Response as Response
