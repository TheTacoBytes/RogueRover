...
class Metaclass_RobotArmArray_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('rr_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_RobotArmArray(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rr_msgs.srv import _robot_arm_array
...
class RobotArmArray(metaclass=Metaclass_RobotArmArray):
    from rr_msgs.srv._robot_arm_array import RobotArmArray_Request as Request
    from rr_msgs.srv._robot_arm_array import RobotArmArray_Response as Response
