...
#ifndef RR_MSGS__SRV__DETAIL__KINEMATICS__FUNCTIONS_H_
#define RR_MSGS__SRV__DETAIL__KINEMATICS__FUNCTIONS_H_
 ...
 * calls
 * rr_msgs__srv__Kinematics_Request__init().
...
/**
 * It calls
 * rr_msgs__srv__Kinematics_Request__fini()
 ...
 * rr_msgs__srv__Kinematics_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rr_msgs__srv__Kinematics_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rr_msgs__srv__Kinematics_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rr_msgs
...
/**
 * It calls
 * rr_msgs__srv__Kinematics_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rr_msgs
...
/**
 * It allocates the memory for the array and calls
 * rr_msgs__srv__Kinematics_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rr_msgs
...
/**
 * It calls
 * rr_msgs__srv__Kinematics_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RR_MSGS__SRV__DETAIL__KINEMATICS__FUNCTIONS_H_
