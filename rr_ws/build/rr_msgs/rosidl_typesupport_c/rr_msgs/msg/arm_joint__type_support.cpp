...
static const _ArmJoint_type_support_symbol_names_t _ArmJoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rr_msgs, msg, ArmJoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rr_msgs, msg, ArmJoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rr_msgs, msg, ArmJoint)() {
  return &::rr_msgs::msg::rosidl_typesupport_c::ArmJoint_message_type_support_handle;
}
