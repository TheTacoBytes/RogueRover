...
static const _Kinematics_Request_type_support_symbol_names_t _Kinematics_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rr_msgs, srv, Kinematics_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rr_msgs, srv, Kinematics_Request)),
  }
};
...
{
  return &::rr_msgs::srv::rosidl_typesupport_cpp::Kinematics_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rr_msgs, srv, Kinematics_Request)() {
  return get_message_type_support_handle<rr_msgs::srv::Kinematics_Request>();
}
...
static const _Kinematics_Response_type_support_symbol_names_t _Kinematics_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rr_msgs, srv, Kinematics_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rr_msgs, srv, Kinematics_Response)),
  }
};
...
{
  return &::rr_msgs::srv::rosidl_typesupport_cpp::Kinematics_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rr_msgs, srv, Kinematics_Response)() {
  return get_message_type_support_handle<rr_msgs::srv::Kinematics_Response>();
}
...
static const _Kinematics_type_support_symbol_names_t _Kinematics_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rr_msgs, srv, Kinematics)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rr_msgs, srv, Kinematics)),
  }
};
...
{
  return &::rr_msgs::srv::rosidl_typesupport_cpp::Kinematics_service_type_support_handle;
}
