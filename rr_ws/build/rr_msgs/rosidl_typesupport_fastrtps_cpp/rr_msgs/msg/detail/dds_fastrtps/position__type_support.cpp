...
#include "rr_msgs/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rr_msgs::msg::Position & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rr_msgs::msg::Position & ros_message)
{
  // Member: angle_x
  cdr >> ros_message.angle_x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rr_msgs::msg::Position;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rr_msgs::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rr_msgs::msg::Position *>(
    untyped_ros_message);
...
{
  return &rr_msgs::msg::typesupport_fastrtps_cpp::_Position__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rr_msgs, msg, Position)() {
  return &rr_msgs::msg::typesupport_fastrtps_cpp::_Position__handle;
}
