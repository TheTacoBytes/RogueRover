...
#include "rr_msgs/srv/detail/robot_arm_array__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rr_msgs::srv::RobotArmArray_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rr_msgs::srv::RobotArmArray_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rr_msgs::srv::RobotArmArray_Request *>(
    untyped_ros_message);
...
{
  return &rr_msgs::srv::typesupport_fastrtps_cpp::_RobotArmArray_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rr_msgs::srv::RobotArmArray_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rr_msgs::srv::RobotArmArray_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rr_msgs::srv::RobotArmArray_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &rr_msgs::srv::typesupport_fastrtps_cpp::_RobotArmArray_Response__handle;
}
...
{
  return &rr_msgs::srv::typesupport_fastrtps_cpp::_RobotArmArray__handle;
}
