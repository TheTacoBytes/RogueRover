...
#include "rr_msgs/srv/detail/kinematics__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rr_msgs::srv::Kinematics_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rr_msgs::srv::Kinematics_Request & ros_message)
{
  // Member: kin_name
  cdr >> ros_message.kin_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rr_msgs::srv::Kinematics_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rr_msgs::srv::Kinematics_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rr_msgs::srv::Kinematics_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_rr_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<rr_msgs::srv::Kinematics_Request>()
{
  return &rr_msgs::srv::typesupport_fastrtps_cpp::_Kinematics_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rr_msgs, srv, Kinematics_Request)() {
  return &rr_msgs::srv::typesupport_fastrtps_cpp::_Kinematics_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rr_msgs
cdr_serialize(
  const rr_msgs::srv::Kinematics_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rr_msgs::srv::Kinematics_Response & ros_message)
{
  // Member: target_joints
  {
    cdr >> ros_message.target_joints;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rr_msgs::srv::Kinematics_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rr_msgs::srv::Kinematics_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rr_msgs::srv::Kinematics_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &rr_msgs::srv::typesupport_fastrtps_cpp::_Kinematics_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rr_msgs, srv, Kinematics_Response)() {
  return &rr_msgs::srv::typesupport_fastrtps_cpp::_Kinematics_Response__handle;
}
...
{
  return &rr_msgs::srv::typesupport_fastrtps_cpp::_Kinematics__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rr_msgs, srv, Kinematics)() {
  return &rr_msgs::srv::typesupport_fastrtps_cpp::_Kinematics__handle;
}
