...
{
  new (message_memory) rr_msgs::msg::PointArray(_init);
}

void PointArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rr_msgs::msg::PointArray *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PointArray_message_member_array[1] = {
  {
    ...
    offsetof(rr_msgs::msg::PointArray, points),  // bytes offset in struct
...
{
  return &::rr_msgs::msg::rosidl_typesupport_introspection_cpp::PointArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rr_msgs, msg, PointArray)() {
  return &::rr_msgs::msg::rosidl_typesupport_introspection_cpp::PointArray_message_type_support_handle;
}
