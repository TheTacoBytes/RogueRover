...
#ifndef RR_MSGS__MSG__DETAIL__TARGET__TRAITS_HPP_
#define RR_MSGS__MSG__DETAIL__TARGET__TRAITS_HPP_
...
inline std::string to_yaml(const rr_msgs::msg::Target & msg)
{
  return rr_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<rr_msgs::msg::Target>()
{
  return "rr_msgs::msg::Target";
}

template<>
inline const char * name<rr_msgs::msg::Target>()
{
  return "rr_msgs/msg/Target";
}

template<>
struct has_fixed_size<rr_msgs::msg::Target>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<rr_msgs::msg::Target>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<rr_msgs::msg::Target>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // RR_MSGS__MSG__DETAIL__TARGET__TRAITS_HPP_
