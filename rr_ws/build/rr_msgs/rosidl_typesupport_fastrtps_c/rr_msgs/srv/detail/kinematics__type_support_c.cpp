...
#include "rr_msgs/srv/detail/kinematics__rosidl_typesupport_fastrtps_c.h"
...
using _Kinematics_Request__ros_msg_type = rr_msgs__srv__Kinematics_Request;
...
size_t get_serialized_size_rr_msgs__srv__Kinematics_Request(
  const void * untyped_ros_message,
...
static uint32_t _Kinematics_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rr_msgs__srv__Kinematics_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rr_msgs
size_t max_serialized_size_rr_msgs__srv__Kinematics_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rr_msgs__srv__Kinematics_Request;
    is_plain =
      (
...
static size_t _Kinematics_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rr_msgs__srv__Kinematics_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rr_msgs, srv, Kinematics_Request)() {
...
using _Kinematics_Response__ros_msg_type = rr_msgs__srv__Kinematics_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rr_msgs
size_t get_serialized_size_rr_msgs__srv__Kinematics_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Kinematics_Response__ros_msg_type * ros_message = static_cast<const _Kinematics_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rr_msgs__srv__Kinematics_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rr_msgs
size_t max_serialized_size_rr_msgs__srv__Kinematics_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rr_msgs__srv__Kinematics_Response;
    is_plain =
      (
...
static size_t _Kinematics_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rr_msgs__srv__Kinematics_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rr_msgs, srv, Kinematics_Response)() {
...
// already included above
// #include "rr_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "rr_msgs/srv/kinematics.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rr_msgs, srv, Kinematics)() {
